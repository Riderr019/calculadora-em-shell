...
●❯────────｢⊙｣────────❮●━"
#-calculos
echo -n "escolha um numero inteiro: "                                  read _N1                                                               echo  "você escolheu $_N1"                                             echo -n "escolha outro: "                                              read _N2                                                               echo  "você escolheu $_N2"                                                                                                                    
echo "●❯────────｢⊙｣────────❮●━"
...
echo "a entre $_N1 e $_N2 é igua a =" $(($_N1+$_N2))
